...
const getAllAdmin = (options, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalData = yield prisma_1.prisma.admin.count({
        where: whereCondition,
    });
    return {
        meta: {
...
const updateAdmin = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const adminData = yield prisma_1.prisma.admin.findUniqueOrThrow({
        where: {
            id: id,
        },
    });
